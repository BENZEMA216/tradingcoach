export default {
  ...
  landing: {
    ...
    betaPrivacyTitle: 'Beta 数据说明',
    betaPrivacyCsvOnly: '仅支持 CSV 导入，暂不支持 Excel 文件。',
    betaPrivacyNoBroker: '不连接券商账号，不登录交易工具，也不会下单。',
    betaPrivacyNotAdvice: 'TradingCoach 是交易复盘工具，不提供投资建议。',
    betaPrivacyTtl: '临时工作区数据互相隔离，72 小时后自动删除。',
    uploadProtocol: '上传协议',
  ...
  loading: {
    ...
    cancelAnalysis: '取消分析',
    cancelledDescription: '该导入任务已停止，不会继续写入新数据。',
    tryAgain: '重试',
    viewPositions: '查看持仓',
    viewDashboard: '统计分析',
    trades: '交易',
  ...
  importPreflight: {
    ...
    failedTitle: '导入预检失败',
    networkTitle: '无法连接导入预检服务',
    networkMessage: '请确认后端服务正在运行，然后重试。当前没有导入任何交易数据。',
    missingEndpointTitle: '导入预检服务不可用',
    missingEndpointMessage: '当前连接的后端不包含导入预检接口。请用最新代码重启后端，然后重试。',
    serverTitle: '导入预检服务异常',
    serverMessage: '后端检查该文件时返回错误。请等待服务恢复后重试。',
    fileMessage: '{{message}}',
    unknownMessage: '未知错误',
    retry: '重试',
    readyTitle: '可以开始导入',
  ...
  upload: {
    ...
    resetData: '删除我的数据',
    resetConfirmTitle: '删除当前工作区',
    resetConfirmDesc: '此操作会删除当前临时工作区中的：',
    resetItem1: '所有交易记录 ({{count}} 条)',
    resetItem2: '所有持仓数据 ({{count}} 个)',
    resetItem3: '所有导入历史',
    resetWarning: '工作区 token 会同时失效。',
    resetting: '删除中...',
    confirmReset: '确认删除我的数据',
    resetSuccess: '当前工作区数据已删除。',
  },
