...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-white dark:bg-black border-r border-neutral-200 dark:border-white/10 flex flex-col z-50 transition-colors duration-200">
      {/* Industrial Header */}
      <div className="h-16 flex items-center px-6 border-b border-neutral-200 dark:border-white/10">
