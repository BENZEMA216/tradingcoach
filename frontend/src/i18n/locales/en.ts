export default {
  ...
  landing: {
    ...
    heroTitle: 'Upload your trades.\nFind the habits costing you money.',
    ...
    betaPrivacyTitle: 'Beta data policy',
    betaPrivacyCsvOnly: 'CSV-only imports. Excel files are not supported yet.',
    betaPrivacyNoBroker: 'No broker login, no account connection, and no order execution.',
    betaPrivacyNotAdvice: 'TradingCoach is a review tool, not investment advice.',
    betaPrivacyTtl: 'Temporary workspace data is isolated and expires after 72 hours.',
  ...
  loading: {
    ...
    cancelledDescription: 'This import task was stopped and will not continue writing data.',
    tryAgain: 'Try Again',
  ...
  importPreflight: {
    ...
    networkTitle: 'Cannot reach import preview service',
    networkMessage: 'Please confirm the backend service is running, then retry. No trade data was imported.',
    missingEndpointTitle: 'Import preview service is not available',
    missingEndpointMessage: 'The current backend does not include the import preview endpoint. Restart the backend with the latest code, then retry.',
    serverTitle: 'Import preview service failed',
    serverMessage: 'The backend returned an error while checking this file. Please retry after the service recovers.',
    fileMessage: '{{message}}',
  ...
  upload: {
    ...
    resetData: 'Delete My Data',
    resetConfirmTitle: 'Delete Current Workspace',
    resetConfirmDesc: 'This action deletes data in this temporary workspace:',
    resetItem1: 'All trade records ({{count}})',
    resetItem2: 'All position data ({{count}})',
    resetItem3: 'All import history',
    resetWarning: 'The workspace token will be invalidated.',
    resetting: 'Deleting...',
    confirmReset: 'Yes, Delete My Data',
    resetSuccess: 'Current workspace data has been deleted.',
  },
