export default {
  ...
  aiCoach: {
    ...
    serviceUnavailable: 'Rule Engine Mode',
  ...
  events: {
    ...
    noEventsDescription: 'Event analysis requires market data. Import market data on the System page first — events will be detected automatically.',
    date: 'Date',
    event: 'Event',
    type: 'Type',
    symbol: 'Symbol',
